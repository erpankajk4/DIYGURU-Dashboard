...
export default function CourseReports({ tab, setMobileMenu }: any) {
          ...
          <div className="my-5">
            <div className="flex justify-between">
              ...
              <div className="flex w-full justify-between">
                <h6 className="mb-3 text-xl">Course Report</h6>
                <button
                  onClick={() =>
                    router.push(
            ...
            <div className="sm:grid grid-cols-10 gap-5">
              {/* Piechart  */}
              <div className="sm:col-span-4 p-4 col-span-10 border-2 rounded-xl">
                <Piechart />
              </div>
              {/* Chart  */}
          ...
          <div className="my-5">
            <div className="sm:grid grid-cols-10 gap-5">
              ...
              <div className="col-span-10 sm:col-span-4  max-sm:mb-5">
                <h6 className="mb-3 text-xl">Popular Courses</h6>
                <div className="rounded-2xl border-2 border-foreground/15 p-4 ">
                  <div className="flex justify-between items-center w-full mb-2">
                    <div>
                      ...
                      <p className="text-zinc-700">Courses</p>
                    </div>
