...
export default function StudentPage({ tab, setMobileMenu }: any) {
    ...
    <>
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-9 sm:pr-10 max-xl:col-span-12">
          ...
          {/* section 1 - Overview */}
          <h2 className="mb-3 text-xl">Student Profile</h2>
          {/* profile section */}
          <ProfileSection database={studentData} />
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <Carddetails
                  ...
                  text="Admission Date"
                  value={studentData?.data[0]?.AdmissionDate}
                ...
                <Carddetails
                  ...
                  value={studentData?.data[0]?.Regno}
                  bgColor="bg-blue-100"
                />
                <Carddetails
                  icon={<MdMenuBook className="text-green-500 w-6 h-6" />}
                  text="Course"
                  value={studentData?.data[0]?.Course}
                  bgColor="bg-green-100"
                />
                <Carddetails
                  icon={<IoMdStopwatch className="text-purple-500 w-6 h-6" />}
                  text="Course Duration"
                  value={studentData?.data[0]?.CourseDuration}
                  bgColor="bg-purple-100"
                />
              </div>

              <TableDetail database={studentData} />
            </>
          )}
