...
const SignupForm = () => {
  ...
  return (
    <div className="w-full py-5 sm:py-10">
      <h1 className="text-2xl sm:text-3xl font-bold text-purple-950 pb-5">
        Create Your Account
      </h1>
      ...
      <p className="text-zinc-900 font-medium text-sm mt-2">Already have an account? <Link className="text-blue-700 hover:underline" href={"/login"}>Login here</Link></p>
    </div>
  );
};
